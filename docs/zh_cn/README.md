...
通过注册账号进入TTFGame开放平台并成功通过审核的用户默认权限即为开发者。若想了解开发者的所有权限支持功能请参照各页面介绍，下文仅对本平台支持开发者的几项主要功能进行说明。

## 2 账号注册与过审

详见[注册文档](http://m_docs.ttfgame.top/)
...
点击绿色的修改按钮后，进入编辑页面，字段含义和限制均与可添加字段中对各字段的介绍相同：
...
测试账号页面默认没有测试账号，用户点击该页面上方的添加按钮即可为自己的平台添加测试账号。测试账号可用于登录内部测试版本，进行版本试玩、测试。
...
选择游戏：默认未选择，该字段表示可以分配给测试人员的游戏，勾选则测试账号可见。
...
开发者账号的游戏创建与发布流程与开发者协作者大致相同，详情请参阅[“游戏开发”](?id=▶-游戏开发)部分。
...
开发者可使用CMS管理的页面，开发者协作者不可使用CMS管理。
...
开发者仅能查看管理该账号下的游戏接入信息，支持查看游戏的相关审核信息。
...
开发者仅能查看该账号下的平台充值订单信息。

![订单管理-平台充值订单-开发者](../img/ttfgame_doc_img_117.jpg)

### 7.5 商户流水

本页面开发者可使用。通过本页面用户可查看商户流水信息。

开发者仅能查看该账号下的商户流水信息。

![订单管理-商户流水-开发者](../img/ttfgame_doc_img_119.jpg)

### 7.6 理财购买订单

本页面开发者可使用。通过本页面用户可查看理财购买订单信息。

开发者仅能查看该账号下的理财购买订单信息。
