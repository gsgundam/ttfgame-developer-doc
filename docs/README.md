...
通過註冊帳號進入TTFGame開放平臺並成功通過審核的用戶默認許可權即為開發者。若想瞭解開發者的所有權限支援功能請參照各頁面介紹，下文僅對本平臺支持開發者的幾項主要功能進行說明。

## 2 帳號註冊與過審

詳見[註冊文檔](http://m_docs.ttfgame.top/)
...
點擊綠色的修改按鈕後，進入編輯頁面，欄位含義和限制均與可添加欄位中對各欄位的介紹相同：
...
測試帳號頁面預設沒有測試帳號，使用者點擊該頁面上方的添加按鈕即可為自己的平臺添加測試帳號。測試帳號可用於登錄內部測試版本，進行版本試玩、測試。
...
選擇遊戲：默認未選擇，該欄位表示可以分配給測試人員的遊戲，勾選則測試帳號可見。
...
開發者帳號的遊戲創建與發佈流程與開發者協作者大致相同，詳情請參閱[“遊戲開發”](?id=▶-遊戲開發)部分。
...
開發者可使用CMS管理的頁面，開發者協作者不可使用CMS管理。
...
開發者僅能查看管理該帳號下的遊戲接入資訊，支援查看遊戲的相關審核資訊。
...
開發者僅能查看該帳號下的平臺充值訂單資訊。

![訂單管理-平臺充值訂單-開發者](./img/ttfgame_doc_img_117.jpg)

### 7.5 商戶流水

本頁面開發者可使用。通過本頁面使用者可查看商戶流水資訊。

開發者僅能查看該帳號下的商戶流水信息。

![訂單管理-商戶流水-開發者](./img/ttfgame_doc_img_119.jpg)

### 7.6 理財購買訂單

本頁面開發者可使用。通過本頁面使用者可查看理財購買訂單資訊。

開發者僅能查看該帳號下的理財購買訂單資訊。
